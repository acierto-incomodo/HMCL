...
public final class Metadata {
    ...
    public static final String NAME = "StormLauncher";
    public static final String FULL_NAME = "StormLauncher";
    ...
    public static final String TITLE = NAME + " v3.5";
    public static final String FULL_TITLE = FULL_NAME + " v3.5";
